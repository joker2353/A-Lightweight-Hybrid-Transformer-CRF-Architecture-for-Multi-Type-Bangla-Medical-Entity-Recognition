...
def train_teacher():
    ...
    print("Loading Teacher Model (BanglaBERT 12-layer)...")
    ...
    print(f"Teacher Test Results: {test_results}")
    
    os.makedirs(TEACHER_OUT_DIR, exist_ok=True)
    trainer.save_model(TEACHER_OUT_DIR)
    tokenizer.save_pretrained(TEACHER_OUT_DIR)
    print(f"Teacher model saved to {TEACHER_OUT_DIR}")
